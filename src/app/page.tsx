  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="flex items-center justify-center min-h-screen px-6 pt-20 relative z-10">
        ...
        {/* Avatar Placeholder */}
        <div className="w-32 h-32 mx-auto mb-8 bg-gradient-to-br from-[#5b17d1] to-purple-600 rounded-full flex items-center justify-center shadow-2xl shadow-[#5b17d1]/20">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
          Hi, I'm{" "}
          <span className="bg-gradient-to-r from-[#5b17d1] to-pink-400 bg-clip-text text-transparent">
            Siddharth
          </span>
          <br />
          <span className="bg-gradient-to-r from-[#5b17d1] to-pink-400 bg-clip-text text-transparent">
